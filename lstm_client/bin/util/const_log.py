...
def init_const():
    ...
    const.PROJECT_NAME = "macdlp-lstm-client"
    ...
    const.LOG_FILE_NAME = project_path + "/logs/macdlp-lstm-client.log"
    const.JSON_CFG_FILE_NAME = project_path + "/conf/client.service.json.conf"
